...
class Calculator:
    ...
    def __init__(self, root):
        ...
        style = ttk.Style()
        style.configure("TButton", font="Serif 15", padding=3)
        style.configure("TEntry", font="Serif 18", padding=5)
        ...
        self.button_mult = ttk.Button(root, text='X', command =lambda: self.math_button_press('X')).grid(row=2,column=3)
